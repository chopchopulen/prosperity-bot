"""
trader_a.py — IMC Prosperity 4 | Tomato Experiment: Variant A
Change: SPREAD=2 (was 3). Hypothesis: more fills at tighter edge.
EMERALDS: +798 baseline penny maker (unchanged).
TOMATOES: baseline WAP+OBI+inv_skew, SPREAD=2.
"""
