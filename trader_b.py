"""
trader_b.py — IMC Prosperity 4 | Tomato Experiment: Variant B
Change: SPREAD=2, OBI_WEIGHT=0. Hypothesis: OBI is noise; clean WAP + tight spread.
EMERALDS: +798 baseline penny maker (unchanged).
TOMATOES: WAP+inv_skew only (no OBI), SPREAD=2.
"""
...
class Trader:
    ...
    def _trade_tomatoes(self, state: TradingState) -> list[Order]:
        ...
        # OBI_WEIGHT = 0.0 — skew term intentionally omitted
        target = wap + inventory_shift
